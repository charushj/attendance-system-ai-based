    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\\Users\\charu\\OneDrive\\Desktop\\Attendance-Management-system-using-face-recognition-master\\attendance"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"C:\Users\charu\OneDrive\Desktop\Attendance-Management-system-using-face-recognition-master\attendance"'
                )
